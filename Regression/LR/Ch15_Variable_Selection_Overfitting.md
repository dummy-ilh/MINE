...
*Synthesized from Kutner, Montgomery, Sheather, and ESL/ISL. Uses Chapter 5's full dataset ($x_1,x_2,y$; $n=5$) to work a complete leave-one-out cross-validation by hand — small enough that every one of the 5 folds can be solved explicitly.*
