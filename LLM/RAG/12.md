Excellent.
Today we enter one of the most misunderstood areas in RAG systems.

You can build a beautiful pipeline.
You can use the best embedding model.
You can scale with Milvus.

But if you cannot **measure retrieval quality**, you are flying blind.
...
## 📅 Day 13 Preview — RAG with Frameworks (LangChain / LlamaIndex)
