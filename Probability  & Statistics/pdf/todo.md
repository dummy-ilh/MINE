...
| Probability | Introduction to Probability Models (Ross) | 3 | 4 | 3 | Applied probability |
| Probability | An Introduction to Probability Theory (Feller) | 5 | 3 | 5 | Deep theory, very hard |
| Statistics | Probability & Statistical Inference (Hogg et al.) | 4 | 5 | 4 | Standard stats foundation |
| Statistics | Introduction to Mathematical Statistics (Hogg) | 5 | 5 | 5 | More rigorous version |
| Statistics | Mathematical Statistics with Applications (Wackerly) | 4 | 5 | 4 | Estimation + testing |
